...
public class ProceduralMap : MonoBehaviour
{
    ...
    private void InitObstaclePool()
    {
        ...
        foreach(Obstacles obstacles in obstacleTypes)
        {
            ...
            {
                Obstacle current = new Obstacle(obstacles.type,spawnable,CreateMainObstaclePool(spawnable.prefab),CreateFollowUpObjectPool(spawnable.followObjs),null, 0, Vector2.zero);
                temp.Add(current);
